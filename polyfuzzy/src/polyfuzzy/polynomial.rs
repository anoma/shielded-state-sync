...
impl Polynomial {
    ...
    pub fn linear_independent_polynomials(m: usize, gamma: usize) -> Vec<Polynomial> {
        let him = hyper_invertible_matrix(m, gamma);
    ...
    pub fn evaluate(&self, point: &Point) -> Scalar {
    ...
    /// Errors if mismatch in coefficients and coordinates lengths.
    pub fn evaluate_in_the_exponent(&self, encoded_point: &EncodedPoint) -> RistrettoPoint {
